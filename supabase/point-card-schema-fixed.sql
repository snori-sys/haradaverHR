...
DROP TRIGGER IF EXISTS update_casts_updated_at ON casts;
...
-- ポイント更新トリガー
DROP TRIGGER IF EXISTS trigger_update_customer_points ON visits;
